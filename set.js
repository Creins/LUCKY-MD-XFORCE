...
module.exports = { session: process.env.SESSION_ID || 'ibraal',
    PREFIXE: process.env.PREFIX || "+",
    GITHUB : process.env.GITHUB|| 'https://github.com/mr-X-force/CREINS-MD-XFORCE',
    ...
    CREINS_ADM : process.env.ANTI_DELETE_MESSAGES || 'no',
